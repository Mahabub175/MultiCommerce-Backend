...
const userSchema = new Schema<IUser>(
  {
    ...
    city1: { type: String, trim: true },
    city2: { type: String, trim: true },
    streetAddress1: { type: String, trim: true },
    streetAddress2: { type: String, trim: true },
    addressSummary1: { type: String, trim: true },
    addressSummary2: { type: String, trim: true },
    country1: { type: String, trim: true },
    country2: { type: String, trim: true },
    zipCode1: { type: String, trim: true },
    zipCode2: { type: String, trim: true },
    shippingAddresses: {
